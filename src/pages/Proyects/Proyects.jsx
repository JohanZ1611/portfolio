    ...
    <div className=" h-screen bg-second-color flex flex-col gap-10 pt-20 justify-center items-center">
      ...
      <div className="w-3/5 h-4/5 flex flex-col gap-4">
        <div className="w-full h-1/2 flex gap-4">
          <div className="w-1/2 h-full overflow-hidden rounded-lg relative">
            <div className="absolute inset-0 bg-color-base opacity-0 hover:opacity-80 transition-opacity">
